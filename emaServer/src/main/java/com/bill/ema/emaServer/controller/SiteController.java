...
public class SiteController {
	...
	public R list(@RequestParam Map<String,Object> param){
		...
		return R.OK(SiteService.queryPage(param));
	}
	...
	public R create(@RequestParam Map<String,Object> param){
		System.out.println(param);
		return R.OK(SiteService.create(param));
	}
	
	@RequestMapping("/edit")
	public R edit(@RequestParam Map<String,Object> param){
		System.out.println(param);
		return R.OK(SiteService.edit(param));
	}
	
	@RequestMapping("/delete")
	public R delete(@RequestParam Map<String,Object> param){
		System.out.println(param);
		return R.OK(SiteService.delete(param));
	}
	...
	public R all() {
		...
		return R.OK(SiteService.list(query));
	}
}
